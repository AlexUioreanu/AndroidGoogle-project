...
public final class FragmentContactBinding implements ViewBinding {
  ...
  private FragmentContactBinding(@NonNull RelativeLayout rootView, @NonNull ImageView appLogo,
      @NonNull LinearLayout linearLayoutContact) {
    this.rootView = rootView;
    this.appLogo = appLogo;
    this.linearLayoutContact = linearLayoutContact;
  }
  ...
  public static FragmentContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linear_layout_contact;
      LinearLayout linearLayoutContact = ViewBindings.findChildViewById(rootView, id);
      if (linearLayoutContact == null) {
        break missingId;
      }

      return new FragmentContactBinding((RelativeLayout) rootView, appLogo, linearLayoutContact);
    }
