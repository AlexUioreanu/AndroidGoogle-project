...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView travelBackground;

  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView textView2, @NonNull ImageView travelBackground) {
    this.rootView = rootView;
    this.textView2 = textView2;
    this.travelBackground = travelBackground;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.travel_background;
      ImageView travelBackground = ViewBindings.findChildViewById(rootView, id);
      if (travelBackground == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, textView2,
          travelBackground);
    }
